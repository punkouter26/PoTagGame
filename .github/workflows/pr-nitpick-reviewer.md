...
tools:
  ...
  github:
    ...
    min-integrity: none
    repos: all # This workflow is allowed to examine any PR because it's invoked by a repo maintainer
...
imports:
  - shared/reporting.md
source: githubnext/agentics/workflows/pr-nitpick-reviewer.md@1f672aef974f4246124860fc532f82fe8a93a57e
---
